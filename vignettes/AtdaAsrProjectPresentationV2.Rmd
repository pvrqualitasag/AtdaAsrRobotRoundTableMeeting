...
rqudocuhelper::insertOdgFigureAsPdf(psOdgFileStem = "Diagramm_Milchdatenfluss")
```
...
rqudocuhelper::insertOdgFigureAsPdf(psOdgFileStem = "Diagramm_Milchkontrolle_DetailBetrieb")
```
...
rqudocuhelper::insertOdgFigureAsPdf(psOdgFileStem = "Diagramm_ZO_Datenverarbeitung")
```
...
rqudocuhelper::insertOdgFigureAsPdf(psOdgFileStem = "Diagramm_Milchkontrolle_DirekterDatentransfer")
```
...
rqudocuhelper::insertOdgFigureAsPdf(psOdgFileStem = "Schaubild_ATDA_Fernwartung")
```
...
rqudocuhelper::insertOdgFigureAsPdf(psOdgFileStem = "Schaubild_ATDA_Cloud")
```
...
rqudocuhelper::insertOdgFigureAsPdf(psOdgFileStem = "Schaubild_ATDA_Webservice")
```
