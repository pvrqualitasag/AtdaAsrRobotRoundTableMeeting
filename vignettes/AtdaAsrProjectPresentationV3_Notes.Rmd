...
* Lassen sie mich auch eines klar und deutlich vorausschicken, wir sind sehr auf ihre Hilfe angewiesen, weil die Daten, die wir gerne transferieren möchten, sind in ihren Systemen auf den Betrieben abgelegt. 
* Nach der Vorstellung des Projektes und bin dann sehr gespannt auf ihre Reaktionen und Rückmeldungen
...
* Meine Präsentation läuft so ab, dass ich in groben Zügen die Abläufe während einer Milchkontrolle beschreibe
* Damit sind sie sicher alle bestens vertraut.
* Aus diese Abläufen erkläre ich dann, weshalb dieses Projekt überhaupt zu Stande kommt und wieso das sinnvoll ist.
* Einfach gesagt, haben wir doch folgende Situation, einerseits
    + gibt es auf den Betrieben moderne Rechenanlagen und Informationssystem und andererseits
    + bei den Zuchtorganisationen haben wir auch ein Rechenzentrum und eine Datenbank
    + aber dazwischen werden die Daten noch übertragen wie noch fast zu Gotthelfs-Zeiten. Da schreibt der Kontrolleur die Milchmengen auf den Begleitschein und schickt den an die Zuchtorganisation.
* Es liegt auf der Hand, dass bei der Datenübertragung Verbesserungspotential vorhanden ist und das wollen wir in diesem Projekt umsetzen. 
* Somit ist das zentrale Ziel dieses Projekts die Datenübertragung technologisch auf einen aktuelleren Stand zu bringen.    
...
4. Die Milchanalyseergebnisse werden dann an die Qualitas übermittelt, wo diese zusammen mit den Milchmengendaten in unsere Datenbank eingetragen werden. 
...
* __Wichtig__: hier ist es, dass dieser Ablauf, im wesentlichen gleich oder ähnlich ist ob ein Betrieb mit einer Robotermelkanlagen oder mit einem konventionellen Melksystemen ausgestattet ist.
